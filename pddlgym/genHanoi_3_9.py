...
def generate_dataset():
    ...
    with open("resultatHanoi3-9.txt", 'w') as file2:
...
#     plt.imsave("hanoi_3-9-pair_"+str(hh)+"_pre.png", im1)
#     plt.close()

#     plt.imsave("hanoi_3-9-pair_"+str(hh)+"_suc.png", im2)
#     plt.close()
